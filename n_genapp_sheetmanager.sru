HA$PBExportHeader$n_genapp_sheetmanager.sru
$PBExportComments$Generated MDI Sheet Management
forward
global type n_genapp_sheetmanager from nonvisualobject
end type
end forward

global type n_genapp_sheetmanager from nonvisualobject
end type
global n_genapp_sheetmanager n_genapp_sheetmanager

type variables
string is_sheets[], is_display[]
w_genapp_basesheet iw_opensheets[]
menu im_items[]
end variables
...
public function long of_sheetisclosing (readonly w_genapp_basesheet aw_sheet)
...
w_genapp_basesheet lw_sheets[], lw_init[]
...
on n_genapp_sheetmanager.destroy
